...
@implementation PointBezierPathView

static NSString *kPointBezierPathLocationOffset = @"PointBezierPathLocationOffset";
    ...
    for (UITouch *touch in touches) {
        ...
        for (CALayer *layer in _hitTestLayers) {
            ...
            if (CGRectContainsPoint(hitBounds, touchLocationInView)) {
                ...
                [layer setValue:[NSValue valueWithCGPoint:offsetFromCenter] forKey:kPointBezierPathLocationOffset];
...
- (void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    for (UITouch *currentTouch in touches) {
        ...
        CGPoint offsetFromCenter = [(NSValue *)[layerToMove valueForKey:kPointBezierPathLocationOffset] CGPointValue];
...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    for (UITouch *currentTouch in touches) {
        ...
        [layer setValue:nil forKey:kPointBezierPathLocationOffset];
